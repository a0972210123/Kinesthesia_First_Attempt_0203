...
class AutorecordFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        touchBoard.setOnTouchListener(object : OnTouchListener {
    ...
    fun outputCsv(fileName: String, input: List<String>, flag: Int) {
        ...
        Toast.makeText(
            activity,
            "自動測驗:$currentTestContext $currentTestDirection 儲存成功",
            Toast.LENGTH_SHORT
        )
            .show()
    ...
    fun goBackToMenu() {
        ...
        findNavController().navigate(R.id.action_autorecordFragment_to_testMenuFragment)
    }
